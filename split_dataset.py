...
def save_images(dataset, dataset_type, root_dir):
...
def split(data_dir, train_ratio, output_dir):
    ...
    save_images(train_set, 'train', output_dir)
    save_images(val_set, 'val', output_dir)
...
split(args.data_dir, args.train_ratio, args.output_dir)
