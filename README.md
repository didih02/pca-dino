...
4. You can adjust the n_component and svd_solver parameters as needed.
5. Results: The classification results will be saved in the classify_pca_dino folder, which is automatically created when you run the code.
