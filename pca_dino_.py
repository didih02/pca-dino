...
if __name__ == "__main__":
    ...
    #Example:
    #python3 pca_dino_.py --dataset cifar10 --load_features output/ ==> without PCA
    #python3 pca_dino_.py --dataset cifar_10 --load_features output/ --act_pca True --n_component 20 --svd_solver randomized --float16 True==> with PCA
